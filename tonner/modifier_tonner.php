        ...
        <div class="modal-body modal-b">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" id="ref" name="ref" class="form-control" placeholder="référence" value='<?php echo $donnes['réf']; ?>' readonly>
              <input type="hidden" name="ref" value='<?php echo $donnes['réf']; ?>'>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" id="marque" name="marque" class="form-control" placeholder="marque" value='<?php echo $donnes['marque']; ?>' disabled required>
              <span class="input-group-addon"><img src="icons/icons8-ball-point-pen-20.png"></span>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="number" id="qte_min" name="qte_min" class="form-control" placeholder="Quantité minimale" value='<?php echo $donnes['qte_min']; ?>' disabled required>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="number" id="qte_stock" name="qte_stock" class="form-control" placeholder="Quantité en stock" value='<?php echo $donnes['qte_stock']; ?>' disabled required>
              <span class="input-group-addon"><img src="icons/icons8-numbers-input-form-20 (1).png"></span>
